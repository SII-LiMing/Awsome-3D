...
> `Awsome-3D` 本仓库聚焦在三维感知，表征，重建和生成。 我们会整理 3D 相关的重要方向、代码、论文、算法、教程、工具等资源，方便快速且全面地入门 3D 领域。
...
## 社区
#### 学术活动 / 社区入口
- [China3DV](http://china3dv.csig.org.cn/index.html)：国内 3D Vision 方向的重要交流平台，适合关注三维重建、几何理解、生成式 3D 等报告与活动。
- [WAIC](https://www.worldaic.com.cn/)：世界人工智能大会，偏学术与产业结合，适合跟踪 3DGen、AIGC、具身智能等热门方向。
- [ACM SIGGRAPH Village](https://village.siggraph.org/)：SIGGRAPH 官方社区入口，适合持续关注图形学、渲染、动画与创作者生态。
- [nerfstudio](https://docs.nerf.studio/)：NeRF / 3DGS 方向常用开源工具与社区入口，适合工程实践、复现和快速原型搭建。

#### 优秀研究者
- [Xiaoguang Han](https://i.cs.hku.hk/~xghan/)：3D reconstruction、digital human、shape analysis 与 generative 3D。
- [Jingyi Yu](https://www.yu-jingyi.com/)：计算摄影、3D vision、neural rendering 与图形学交叉方向。
- [Sida Peng](https://pengsida.net/)：neural rendering、human performance capture、dynamic 3D reconstruction。
- [Daniel Cohen-Or](https://danielcohenor.com/)：computer graphics、geometry processing、3D shape analysis 与生成。

#### 自媒体 / 资讯
- [机器之心](https://www.jiqizhixin.com/)：AI 综合资讯平台，适合快速了解学界与工业界动态。
- [量子位](https://www.qbitai.com/)：AI 科技媒体，覆盖模型、创业、产品与研究趋势。
- [新智元](https://aiera.com.cn/)：偏 AI 与产业动态，也会追踪多模态、AIGC 与机器人方向。
- [3D 视觉工坊](https://space.bilibili.com/3493136117913956)：中文 3D vision / CV 内容入口，适合入门和跟踪热门方法。
